...
def detect(save_img=False):
    source, weights, view_img, save_txt, imgsz, cctv = opt.source, opt.weights, opt.view_img, opt.save_txt, opt.img_size, opt.cctv
        ...
        if cctv == 1:
            ...
            while True:
                ...
                if count % 1 == 0:
                    ...
                    cv2.imwrite("../../CaptureImages/frame%d.jpg" % count, resized)
